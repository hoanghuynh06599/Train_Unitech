...
const ListCategories = lazy(() => import("../../../components/categoriesConfig/ListCategories"))
...
const CategoriesConfig = () => {
    ...
    return (
        <AdminLayout>
            <div className="mt-5">
                <h3 className="py-4 my-6 text-3xl font-semibold">Danh mục cấu hình</h3>
                ...
                <div className="bg-white">
                    <div className="flex justify-end p-6">
                        <button
                            ...
                            onClick={() => navigate("/management/create/categories-config")}
                        >
                            Tạo mới
                        </button>
                    </div>
