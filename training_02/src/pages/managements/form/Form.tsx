...
const ListForm = lazy(() => import("../../../components/form/ListForms"))
...
const FormPage = () => {
    ...
    const handleSearch = () => {
        searchContext?.setFormSearch(searchValue)
    }

    return (
        <div className="mt-5">
            <h3 className="py-4 my-6 text-3xl font-semibold">Form</h3>
            ...
            <div className="bg-white">
                <div className="flex justify-end p-6">
                    <button
                        ...
                        onClick={() => navigate("/administrator/builder/data/create/form")}
                    >
                        Tạo mới
                    </button>
                </div>
