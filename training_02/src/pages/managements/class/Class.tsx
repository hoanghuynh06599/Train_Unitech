...
const ListClass = lazy(() => import("../../../components/class/ListClass"))
...
const ClassPage = () => {
    ...
    const handleSearch = () => {
        searchContext?.setClassSearch(searchValue)
    }

    return (
        <div className="mt-5">
            <h3 className="py-4 my-6 text-3xl font-semibold">Lớp học</h3>
